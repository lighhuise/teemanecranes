...
function MediaTextRenderer({ data }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				(data.heading || data.subheading) && /* @__PURE__ */ jsxs("div", {
					className: "space-y-2",
					children: [data.subheading && /* @__PURE__ */ jsx("p", {
						className: "text-sm font-bold tracking-widest uppercase text-primary",
						children: data.subheading
					}), data.heading && /* @__PURE__ */ jsx("h3", {
						className: "text-3xl lg:text-4xl font-black tracking-tighter text-foreground leading-[1.1]",
						children: data.heading
					})]
				}),
				data.content && /* @__PURE__ */ jsx("div", {
					className: "prose prose-neutral dark:prose-invert max-w-none text-muted-foreground prose-a:text-primary hover:prose-a:underline",
					dangerouslySetInnerHTML: { __html: data.content }
				}),
			...
			className: "flex-1 min-w-0 w-full h-[400px] md:h-[500px] relative group",
...
//# sourceMappingURL=show-Cn8VQGYG.js.map