...
import { t as FloatingStatCard } from "./floating-stat-card-DWmFEXbQ.js";
...
//#region resources/images/Teemane-Boat.webp
var Teemane_Boat_default = "/build/assets/Teemane-Boat-DihsRzVb.webp";
//#endregion
//#region resources/js/pages/about-us.tsx
function AboutUs() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsx(Head, { title: "About Us - Teemane Cranes" }),
		/* @__PURE__ */ jsxs("div", {
			className: "bg-muted/30 py-24 lg:py-32 border-b border-border relative overflow-hidden",
			children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--color-primary),transparent_50%)] opacity-10" }), /* @__PURE__ */ jsx(Wrapper, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("h1", {
							className: "text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-foreground uppercase leading-[1.1] mb-8",
							children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Established in 2012, Teemane Cranes prides itself on countless victories across South Africa's most demanding worksites, from high-stakes projects to complex operations."
						})
					]
				})
			})]
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsx(Wrapper, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("h2", {
							className: "text-3xl md:text-4xl font-black uppercase text-foreground leading-[1.2]",
			...
			children: /* @__PURE__ */ jsx(Wrapper, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionHeading, {
						...
						href: "/contact-us",
						className: "inline-flex items-center gap-3 bg-gradient-to-r from-primary to-primary/70 hover:from-primary/90 hover:to-primary text-primary-foreground transition-all shadow-sm hover:shadow px-8 py-4 rounded-lg font-bold tracking-widest uppercase text-sm",
...
AboutUs.layout = (page) => /* @__PURE__ */ jsx(AppLayout, { children: page });
//#endregion
export { AboutUs as default };

//# sourceMappingURL=about-us-ktGwZ-wO.js.map