...
function Navigation$1() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
		className: "bg-black/75 dark:bg-white/75 text-white/75 dark:text-black/75 text-[8px]  font-bold py-2.5 px-4 tracking-[0.2em] uppercase border-b border-border hidden sm:block",
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("h2", {
						className: "text-3xl md:text-5xl font-black uppercase tracking-tighter leading-[1.1] tracking-tight",
...
var Map = lazy(() => import("./map-DLSbecTl.js"));
...
//# sourceMappingURL=app-layout-DhyCzL_b.js.map