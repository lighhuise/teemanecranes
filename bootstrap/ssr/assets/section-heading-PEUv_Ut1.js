import { c as cn } from "./app-layout-ChrZiSip.js";
...
function SectionHeading({ label, title, children, align = "center", className }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("h2", {
				className: "text-4xl lg:text-5xl max-w-2xl text-balance font-bold tracking-wider text-foreground leading-[1.1]",
				children: title
			}),
...
//# sourceMappingURL=section-heading-PEUv_Ut1.js.map