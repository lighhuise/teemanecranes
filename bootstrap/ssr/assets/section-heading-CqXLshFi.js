import { c as cn } from "./app-layout-0hJMmrhr.js";
...
function SectionHeading({ label, title, children, align = "center", className }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("h2", {
				className: "text-4xl lg:text-5xl max-w-2xl text-balance font-black tracking-tighter text-foreground leading-[1.1]",
				children: title
			}),
...
//# sourceMappingURL=section-heading-CqXLshFi.js.map