import { o as buttonVariants, s as Wrapper, t as AppLayout } from "./app-layout-ChrZiSip.js";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h1", {
					className: "text-5xl sm:text-6xl font-bold tracking-wider leading-[0.9] text-white drop-shadow-lg",
					children: [
						"A CUT ABOVE ",
						/* @__PURE__ */ jsx("br", {}),
						/* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx(Wrapper, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsxs("h1", {
							className: "text-[5vw] xl:text-[75px] font-bold tracking-wider leading-[0.9] text-foreground",
							children: [
								"A CUT ABOVE ",
								/* @__PURE__ */ jsx("br", {}),
								/* @__PURE__ */ jsx("span", {
		...
		children: /* @__PURE__ */ jsx(Wrapper, { children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("h2", {
						className: "text-4xl lg:text-5xl font-bold tracking-wider text-foreground leading-[1.1] ",
						children: [
							"THE ONLY NAME ",
							/* @__PURE__ */ jsx("br", {}),
							"TRUSTED TO PERFORM"
		...
		children: /* @__PURE__ */ jsxs(Wrapper, { children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: services.map((service, idx) => /* @__PURE__ */ jsx("div", {
					className: "group relative p-8 bg-background border border-border flex flex-col justify-between min-h-65 transition-all hover:border-primary hover:shadow-lg hover:-translate-y-1 rounded-md cursor-default",
					children: /* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							/* @__PURE__ */ jsxs("span", {
...
//# sourceMappingURL=home-CTI0lfMA.js.map